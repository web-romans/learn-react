        ...
        return (
            <div className="users">
                <ul className="users__list">
                    {
                        this.props.users.map((u) => <li key={u.id} className="users__item user-block">
                            ...
                            <div className="user-block__info">
                                ...
                                <div className="user-block__status">  {u.status} </div>
                                {
                                    (u.followed)
                                        ?
                                        <button onClick={() => { this.props.unfollow(u.id) }} className="user-block__btn user-block__btn--unfollow">
                                        ...
                                        :
                                        <button onClick={() => { this.props.follow(u.id) }} className="user-block__btn user-block__btn--follow">
