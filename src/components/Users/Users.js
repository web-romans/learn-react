                    ...
                    props.users.map((u) => <li key={u.id} className="users__item user-block">
                        ...
                        <div className="user-block__info">
                            ...
                            <div className="user-block__status">  {u.status} </div>
                            {
                                (u.followed)
                                    ?
                                    <button onClick={() => { props.unfollow(u.id) }} className="user-block__btn user-block__btn--unfollow">
                                    ...
                                    :
                                    <button onClick={() => { props.follow(u.id) }} className="user-block__btn user-block__btn--follow">
